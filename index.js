...
// setTimeout(() => {
//   console.log("Where would I Be?");
// }, 2000);

// console.log("End");

// setTimeout is a function that allows you to execute a function after a certain amount of time.
...
setInterval(() => {
  ...
  .then((data) => {
    display.innerHTML = `<h1>${data.fact}</h1>`;
  })
  .catch((error) => {
